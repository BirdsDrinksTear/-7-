...
const ALL_QUESTIONS = [
  ...
  { emoji:'🐢', cat:'어류 · 중류', q:'자라의 특징으로 옳은 것은?', choices:['오렌지색 앞니가 있다','등딱지가 부드럽고 코가 길쭉하다','날개 폭이 2m 이상이다','강한 포식성 외래 어종이다'], ans:1, explain:'자라는 거북과 비슷하지만 부드러운 등딱지와 길쭉한 코가 특징이에요.' },
  { emoji:'🐢', cat:'어류 · 중류', q:'자라가 주로 사는 곳은?', choices:['강과 호수 주변','사막','깊은 바다','나무 위'], ans:0, explain:'자라는 강이나 호수 주변의 모래밭 근처에서 생활해요.' },
